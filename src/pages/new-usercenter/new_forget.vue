    ...
    <div class="login-bg">
        ...
        <div class="login-frame">
            ...
            <div class="login-item">
                ...
                <div class="item-right">
                    <div class="input-wrap">
                        <input placeholder="请输入新密码" v-model="userpwd" type="password" maxlength="16"/>
                    </div>
                </div>
            </div>
            <div class="login-item">
...
<style scoped>
   ...
   .login-header{line-height: 100px; padding: 0 5%;}
   .get-verify{border: none !important; color: #F5A623 !important;margin-top: 1.5em !important;}
   .sub-btn{background: #F5A623;margin-top: 5em;}
</style>
<script>
//引入请求方法
...
export default {
    ...
    methods:{
        ...
        resetPwd(){
            ...
            res.then(function(res){
                Toast("重设成功");
                self.$router.push({path: '/newlogin'});
